...
/**
 * Returns a function that takes an object containing <code>borderBottomRightRadius</code> and <code>theme</code> properties.
 *
...
export default fallback => {
  ...
  fn.propName_ = 'borderBottomRightRadius'
